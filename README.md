...
- `audit.flush.delay.fixed` - fixed delay between automatic audit flushes (default: `1000`)
- `audit.flush.delay.initial` - initial delay before automatic audit flushing starts (default: `1000`)
